...
class AffiliateControllerTest extends WebTestCase
{
    ...
    public function testAffiliateForm()
    {
        ...
        $this->assertEquals('MyBundle\Controller\AffiliateController::newAction', $client->getRequest()->attributes->get('_controller'));
        ...
        $client->submit($form);
        $this->assertEquals('MyBundle\Controller\AffiliateController::createAction', $client->getRequest()->attributes->get('_controller'));
    ...
    public function testCreate()
    {
        ...
        $this->assertEquals('MyBundle\Controller\AffiliateController::waitAction', $client->getRequest()->attributes->get('_controller'));
