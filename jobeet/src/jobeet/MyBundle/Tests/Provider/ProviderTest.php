...
class ProviderTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    private function getMockedDatabaseManager()
    {
        return $this
            ->getMockBuilder('jobeet\MyBundle\Manager\Manager')
