...
class JobControllerTest extends WebTestCase
{
    public function testIndex()
    {
        ...
        $this->assertEquals('MyBundle\Controller\JobController::indexAction',
        ...
        $this->assertEquals('MyBundle\Controller\JobController::showAction', $client->getRequest()->
    ...
    public function testSortedByDate()
    {
        ...
        $this->markTestIncomplete("Returns 0 instead of 1");
    ...
    public function testClicks()
    {
        ...
        $link = $crawler->selectLink('Web Developer')->first()->link();
        $crawler = $client->click($link);
        $this->assertEquals('MyBundle\Controller\JobController::showAction', $client->getRequest()->attributes->get('_controller'));
        $this->assertEquals($job->getCompanySlug(), $client->getRequest()->attributes->get('company'));
        $this->assertEquals($job->getLocationSlug(), $client->getRequest()->attributes->get('location'));
        $this->assertEquals($job->getPositionSlug(), $client->getRequest()->attributes->get('position'));
        $this->assertEquals($job->getId(), $client->getRequest()->attributes->get('id'));
    ...
    public function testJobForm()
    {
        ...
        $this->assertEquals('MyBundle\Controller\JobController::newAction', $client->getRequest()->attributes->get('_controller'));
        ...
        $client->submit($form);
        $this->assertEquals('MyBundle\Controller\JobController::createAction', $client->getRequest()->attributes->get('_controller'));

        $this->markTestIncomplete("Request not redirrected");
        $client->followRedirect();
        $this->assertEquals('MyBundle\Controller\JobController::previewAction', $client->getRequest()->attributes->get('_controller'));
        $kernel = static::createKernel();
        $kernel->boot();
        $em = $kernel->getContainer()->get('doctrine.orm.entity_manager');

        $query = $em->createQuery('SELECT count(j.id) from MyBundle:Job j WHERE j.location = :location AND j.is_activated IS NULL AND j.is_public = 0');
    ...
    public function testSubmitWrongData()
    {
        ...
        $this->markTestIncomplete("Returns 0 errors-");
    ...
    public function testPublishJob()
    {
        ...
        $query = $em->createQuery('SELECT count(j.id) from MyBundle:Job j WHERE j.position = :position AND j.is_activated = 1');
    ...
    public function testDeleteJob()
    {
        ...
        $query = $em->createQuery('SELECT count(j.id) from MyBundle:Job j WHERE j.position = :position');
    ...
    public function testExtendJob()
    {
        ...
        $kernel->boot();
        $em = $kernel->getContainer()->get('doctrine.orm.entity_manager');
        $job = $em->getRepository('MyBundle:Job')->findOneByPosition('FOO5');
    ...
    public function getJobByPosition($position)
    {
        ...
        $query = $em->createQuery('SELECT j from MyBundle:Job j WHERE j.position = :position');
